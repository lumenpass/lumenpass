...
/// Low-level WebDAV client. Singleton so it can be shared by
/// `CloudDatabaseService` and `CloudSyncService`, mirroring how the other
/// cloud providers are wired on mobile.
///
