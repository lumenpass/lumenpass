...
class SftpConfig {
  ...
  SftpConfig copyWith({
    ...
    return SftpConfig(
      ...
      keyFileBookmark: keyFileBookmark ?? this.keyFileBookmark,
  ...
  factory SftpConfig.fromJson(
    ...
    return SftpConfig(
      ...
      keyFileBookmark: json['keyFileBookmark'] as String?,
...
class SftpService {
  ...
  Future<String> _readKeyFile(SftpConfig cfg) async {
    var path = cfg.keyFilePath;
    final bookmark = cfg.keyFileBookmark;
